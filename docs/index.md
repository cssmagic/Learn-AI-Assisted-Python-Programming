...
034| 关于作者 | | 〃 |
035| 关于封面插图 | | 〃 |
090| [欢迎加入](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/1) |[试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/1)| - |本书早期预览版的欢迎语。
||||
**第一章** | **走近 AI 辅助编程** || (待出版) |
100 | 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/2) | |
...
||||
**第二章** | **快速上手 Copilot**|| (待出版)|
200 | 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/29)
...
||||
**第三章** | **设计函数**|| (待出版)|
300 | 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/27)
...
||||
**第四章** | **理解 Python 代码（上）**|| (待出版)|
400| 本章内容概要 |  [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/25)
401| 为什么我们需要阅读代码 | -
402| 要求 Copilot 解释代码 | -
403| 必知必会的十大编程特性：第一部分 | -
404| 本章小结 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/26)
||||
**第五章** | **理解 Python 代码（下）**|  | (待出版)|
500| 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/11)
501| 必知必会的十大编程特性：第二部分 | -
502| 本章小结 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/18)
||||
**第六章** | **程序测试与提示工程**|  | (待出版)|
600| 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/12)
601| 为什么测试代码至关重要 | -
602| 黑盒测试与白盒测试 | -
603| 如何测试你的代码 | -
...
||||
**第七章** | **问题分解**| | (待出版)|
700| 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/13)
701| 问题分解 | -
702| 从顶至下设计的小示例 | -
703| 作者特征识别 | -
...
||||
**第八章** | **调试代码并且更深入地理解代码**|  |(待出版)|
800| 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/14)
801| 错误（Bug）是如何产生的？ | -
802| 如何找出 Bug | -
803| 发现 Bug 后如何修复 | -
804| 根据我们的新技能调整工作流程 | -
...
||||
**第九章** | **繁琐事务自动化**|  |(待出版)|
900| 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/15)
901| 程序员为何制作工具 | -
...
||||
**第十章** | **开发小游戏**|  |(待出版)|
1000| 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/16)
1001| 游戏设计入门 | -
1002| 加入随机性 | -
1003| 示例一：“数字猜猜乐” | -
1004| 示例二：“饿死胆小鬼” | -
...
||||
**第十一章** | **展望未来**|  |(待出版)|
1100| 本章内容概要 | [试读](https://github.com/cssmagic/Learn-AI-Assisted-Python-Programming/issues/17)
1101| 提示模式 | -
1102| 当前局限与未来趋势 | -
